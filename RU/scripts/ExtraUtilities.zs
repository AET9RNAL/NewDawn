...
recipes.addShaped(<extrautils2:machine>.withTag({Type: "extrautils2:generator"}), [[<taiga:solarium_ingot>, <taiga:solarium_ingot>, <taiga:solarium_ingot>],[<taiga:solarium_ingot>, <extrautils2:machine>, <taiga:solarium_ingot>], [<minecraft:redstone_block>, <extrautils2:machine>, <minecraft:redstone_block>]]);
...
recipes.addShaped(<extrautils2:drum:2>, [[<thermalfoundation:material:33>, <extrautils2:drum:1>, <thermalfoundation:material:33>],[<moreplates:diamond_plate>, <extrautils2:drum:1>, <moreplates:diamond_plate>], [<thermalfoundation:material:33>, <extrautils2:drum:1>, <thermalfoundation:material:33>]]);
...
recipes.addShaped(<extrautils2:machine>.withTag({Type: "extrautils2:generator_netherstar"}), [[<minecraft:skull:1>, <botania:specialflower>.withTag({type: "ba_wither_flower"}), <minecraft:skull:1>],[<minecraft:skull:1>, <astralsorcery:itemshiftingstar>, <minecraft:skull:1>], [<contenttweaker:plate_starmetal>, <extrautils2:machine>.withTag({Type: "extrautils2:generator"}), <contenttweaker:plate_starmetal>]]);
recipes.addShaped(<extrautils2:machine>.withTag({Type: "extrautils2:generator_overclock"}), [[<teslacorelib:speed_tier2>, <teslacorelib:speed_tier2>, <teslacorelib:speed_tier2>],[<teslacorelib:speed_tier2>, <bloodmagic:blood_rune:1>, <teslacorelib:speed_tier2>], [<moreplates:redstone_alloy_plate>, <extrautils2:machine>.withTag({Type: "extrautils2:generator"}), <moreplates:redstone_alloy_plate>]]);
recipes.addShaped(<extrautils2:machine>.withTag({Type: "extrautils2:generator_tnt"}), [[<extrautils2:unstableingots>, <minecraft:tnt>, <extrautils2:unstableingots>],[<extrautils2:unstableingots>, <botania:specialflower>.withTag({type: "entropinnyum"}), <extrautils2:unstableingots>], [<moreplates:red_alloy_plate>, <extrautils2:machine>.withTag({Type: "extrautils2:generator"}), <moreplates:red_alloy_plate>]]);
recipes.addShaped(<extrautils2:machine>.withTag({Type: "extrautils2:generator_death"}), [[<enderio:item_material:81>, <enderio:item_material:81>, <enderio:item_material:81>],[<enderio:item_material:81>, <xlfoodmod:deadly_energy_drink>, <enderio:item_material:81>], [<moreplates:red_alloy_plate>, <extrautils2:machine>.withTag({Type: "extrautils2:generator"}), <moreplates:red_alloy_plate>]]);
...
recipes.addShaped(<extrautils2:machine>.withTag({Type: "extrautils2:generator_ice"}), [[<futuremc:blue_ice>, <futuremc:blue_ice>, <futuremc:blue_ice>],[<futuremc:blue_ice>, <divinerpg:snow_globe>, <futuremc:blue_ice>], [<moreplates:red_alloy_plate>, <extrautils2:machine>.withTag({Type: "extrautils2:generator"}), <moreplates:red_alloy_plate>]]);
recipes.addShaped(<extrautils2:machine>.withTag({Type: "extrautils2:generator_slime"}), [[<tconstruct:materials:9>, <tconstruct:materials:10>, <tconstruct:materials:11>],[<tconstruct:materials:9>, <moreplates:knightslime_plate>, <tconstruct:materials:9>], [<moreplates:red_alloy_plate>, <extrautils2:machine>.withTag({Type: "extrautils2:generator"}), <moreplates:red_alloy_plate>]]);
recipes.addShaped(<extrautils2:machine>.withTag({Type: "extrautils2:generator_enchant"}), [[<botania:manaresource:22>, <extrautils2:decorativesolidwood:1>, <botania:manaresource:22>],[<botania:manaresource:22>, <cyclicmagic:block_enchanter>, <botania:manaresource:22>], [<moreplates:red_alloy_plate>, <extrautils2:machine>.withTag({Type: "extrautils2:generator"}), <moreplates:red_alloy_plate>]]);
recipes.addShaped(<extrautils2:machine>.withTag({Type: "extrautils2:generator_pink"}), [[<mysticalagriculture:crafting:10>, <mysticalagriculture:crafting:10>, <mysticalagriculture:crafting:10>],[<mysticalagriculture:crafting:10>, <jaopca:block.amber>, <mysticalagriculture:crafting:10>], [<enderio:item_alloy_ingot:3>, <extrautils2:machine>.withTag({Type: "extrautils2:generator"}), <enderio:item_alloy_ingot:3>]]);
...
recipes.addShaped(<extrautils2:angelblock>, [[null, null, null],[null, <minecraft:gold_ingot>, null], [<minecraft:feather>, <cyclicmagic:crystallized_obsidian>, <minecraft:feather>]]);
...
// Deep Dark Portal
//recipes.remove(<extrautils2:teleporter:1>);
//mods.avaritia.ExtremeCrafting.addShaped("Deep Dark Portal", <extrautils2:teleporter:1> * 1, [[null, null, null, null, null, null, null, null, null], [null, null, null, null, null, null, null, null, null],[null, null, null, <extrautils2:compressedcobblestone:5>, <extrabotany:material:9>, <extrautils2:compressedcobblestone:5>, null, null, null],[null, null, <extrautils2:compressedcobblestone:5>, <industrialupgrade:charging_lapotron_crystal>, <contenttweaker:circuit_void>, <industrialupgrade:charging_lapotron_crystal>, <extrautils2:compressedcobblestone:5>, null, null],[null, null, <bloodmagic:component:4>, <contenttweaker:circuit_void>, <industrialupgrade:simplemachine:6>, <contenttweaker:circuit_void>, <bloodmagic:component:4>, null, null],[null, null, <extrautils2:compressedcobblestone:5>, <industrialupgrade:charging_lapotron_crystal>, <contenttweaker:circuit_void>, <industrialupgrade:charging_lapotron_crystal>, <extrautils2:compressedcobblestone:5>, null, null],[null, null, null, <extrautils2:compressedcobblestone:5>, <bloodmagic:component:4>, <extrautils2:compressedcobblestone:5>, null, null, null],[null, null, null, null, null, null, null, null, null],[null, null, null, null, null, null, null, null, null]]);
recipes.addShaped(<extrautils2:teleporter:1>, [[<extrautils2:compressedcobblestone:2>, <extrautils2:compressedcobblestone:2>, <extrautils2:compressedcobblestone:2>],[<extrautils2:compressedcobblestone:2>, <bloodmagic:component:4>, <extrautils2:compressedcobblestone:2>], [<extrautils2:compressedcobblestone:2>, <extrautils2:compressedcobblestone:2>, <extrautils2:compressedcobblestone:2>]]);
