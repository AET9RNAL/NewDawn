...
recipes.addShaped(<extrautils2:machine>.withTag({Type: "extrautils2:generator_overclock"}), [[<teslacorelib:speed_tier2>, <teslacorelib:speed_tier2>, <teslacorelib:speed_tier2>],[<teslacorelib:speed_tier2>, <minecraft:barrier>, <teslacorelib:speed_tier2>], [<moreplates:redstone_alloy_plate>, <extrautils2:machine>.withTag({Type: "extrautils2:generator"}), <moreplates:redstone_alloy_plate>]]);
recipes.addShaped(<extrautils2:machine>.withTag({Type: "extrautils2:generator_tnt"}), [[<extrautils2:unstableingots>, <minecraft:tnt>, <extrautils2:unstableingots>],[<extrautils2:unstableingots>, <botania:specialflower>.withTag({type: "entropinnyum"}), <extrautils2:unstableingots>], [<minecraft:barrier>, <extrautils2:machine>.withTag({Type: "extrautils2:generator"}), <minecraft:barrier>]]);
recipes.addShaped(<extrautils2:machine>.withTag({Type: "extrautils2:generator_death"}), [[<enderio:item_material:81>, <enderio:item_material:81>, <enderio:item_material:81>],[<enderio:item_material:81>, <xlfoodmod:deadly_energy_drink>, <enderio:item_material:81>], [<minecraft:barrier>, <extrautils2:machine>.withTag({Type: "extrautils2:generator"}), <minecraft:barrier>]]);
...
recipes.addShaped(<extrautils2:machine>.withTag({Type: "extrautils2:generator_ice"}), [[<futuremc:blue_ice>, <futuremc:blue_ice>, <futuremc:blue_ice>],[<futuremc:blue_ice>, <divinerpg:snow_globe>, <futuremc:blue_ice>], [<minecraft:barrier>, <extrautils2:machine>.withTag({Type: "extrautils2:generator"}), <minecraft:barrier>]]);
recipes.addShaped(<extrautils2:machine>.withTag({Type: "extrautils2:generator_slime"}), [[<tconstruct:materials:9>, <tconstruct:materials:10>, <tconstruct:materials:11>],[<tconstruct:materials:9>, <moreplates:knightslime_plate>, <tconstruct:materials:9>], [<minecraft:barrier>, <extrautils2:machine>.withTag({Type: "extrautils2:generator"}), <minecraft:barrier>]]);
recipes.addShaped(<extrautils2:machine>.withTag({Type: "extrautils2:generator_enchant"}), [[<botania:manaresource:22>, <extrautils2:decorativesolidwood:1>, <botania:manaresource:22>],[<botania:manaresource:22>, <minecraft:barrier>, <botania:manaresource:22>], [<minecraft:barrier>, <extrautils2:machine>.withTag({Type: "extrautils2:generator"}), <minecraft:barrier>]]);
recipes.addShaped(<extrautils2:machine>.withTag({Type: "extrautils2:generator_pink"}), [[<mysticalagriculture:crafting:10>, <mysticalagriculture:crafting:10>, <mysticalagriculture:crafting:10>],[<mysticalagriculture:crafting:10>, <minecraft:barrier>, <mysticalagriculture:crafting:10>], [<enderio:item_alloy_ingot:3>, <extrautils2:machine>.withTag({Type: "extrautils2:generator"}), <enderio:item_alloy_ingot:3>]]);
...
recipes.addShaped(<extrautils2:angelblock>, [[null, null, null],[null, <minecraft:gold_ingot>, null], [<minecraft:feather>, <minecraft:barrier>, <minecraft:feather>]]);
...
// Deep Dark Portal
//recipes.remove(<extrautils2:teleporter:1>);
recipes.addShaped(<extrautils2:teleporter:1>, [[<extrautils2:compressedcobblestone:2>, <extrautils2:compressedcobblestone:2>, <extrautils2:compressedcobblestone:2>],[<extrautils2:compressedcobblestone:2>, <minecraft:barrier>, <extrautils2:compressedcobblestone:2>], [<extrautils2:compressedcobblestone:2>, <extrautils2:compressedcobblestone:2>, <extrautils2:compressedcobblestone:2>]]);
