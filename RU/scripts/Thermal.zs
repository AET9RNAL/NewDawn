...
recipes.addShaped(<thermalexpansion:tank>, [[<thermalfoundation:material:355>, <thermalfoundation:material:512>, <thermalfoundation:material:355>],[<thermalfoundation:material:291>, <cyclicmagic:block_storeempty>, <thermalfoundation:material:291>], [<thermalfoundation:material:355>, <thermalfoundation:material:512>, <thermalfoundation:material:355>]]);

recipes.addShaped(<thermalexpansion:machine:8>, [[<cyclicmagic:fluid_drain>, <cyclicmagic:block_storeempty>, <cyclicmagic:fluid_drain>],[<extrautils2:decorativeglass>, <thermalexpansion:frame>, <extrautils2:decorativeglass>], [<thermalfoundation:material:256>, <thermalfoundation:material:513>, <thermalfoundation:material:256>]]);
recipes.addShaped(<thermalexpansion:machine:6>, [[<cyclicmagic:melter>, <ore:blockGlassHardened>, <cyclicmagic:melter>],[<minecraft:nether_brick>, <thermalexpansion:frame>, <minecraft:nether_brick>], [<thermalfoundation:material:256>, <thermalfoundation:material:513>, <thermalfoundation:material:256>]]);
recipes.addShaped(<thermalexpansion:machine:3>, [[<cyclicmagic:melter>, <ore:gearInvar>, <cyclicmagic:melter>],[<extrautils2:compressedsand:1>, <thermalexpansion:frame>, <extrautils2:compressedsand:1>], [<ore:gearCopper>, <thermalfoundation:material:513>, <ore:gearCopper>]]);
...
recipes.addShaped(<thermalexpansion:machine>, [[<randomthings:igniter>, <jaopca:block.red_alloy>, <cyclicmagic:melter>],[<minecraft:brick_block>, <thermalexpansion:frame>, <minecraft:brick_block>], [<thermalfoundation:material:256>, <thermalfoundation:material:513>, <thermalfoundation:material:256>]]);
...
recipes.addShaped(<thermaldynamics:retriever:4> * 2, [[<contenttweaker:plate_alloy_thermal>, null, <contenttweaker:plate_alloy_thermal>],[<simplyjetpacks:metaitemmods:19>, <thermalfoundation:glass_alloy:7>, <simplyjetpacks:metaitemmods:19>], [<endreborn:ingot_infused>, <cyclicmagic:ender_pearl_reuse>, <endreborn:ingot_infused>]]);
recipes.addShaped(<thermaldynamics:retriever:3> * 2, [[null, null, null],[<thermalfoundation:material:357>, <thermalfoundation:glass_alloy:5>, <thermalfoundation:material:357>], [<thermalfoundation:material:165>, <cyclicmagic:ender_pearl_reuse>, <thermalfoundation:material:165>]]);
recipes.addShaped(<thermaldynamics:retriever:2> * 2, [[null, null, null],[<industrialupgrade:itemdoubleplates:13>, <industrialupgrade:glass>, <industrialupgrade:itemdoubleplates:13>], [<thermalfoundation:material:161>, <cyclicmagic:ender_pearl_reuse>, <thermalfoundation:material:161>]]);
recipes.addShaped(<thermaldynamics:retriever:1> * 2, [[null, null, null],[<simplyjetpacks:metaitemmods:18>, <extrautils2:decorativeglass>, <simplyjetpacks:metaitemmods:18>], [<ore:ingotInvar>, <cyclicmagic:ender_pearl_reuse>, <ore:ingotInvar>]]);
recipes.addShaped(<thermaldynamics:retriever> * 2, [[null, null, null],[<minecraft:iron_nugget>, <extrautils2:decorativeglass>, <minecraft:iron_nugget>], [<minecraft:iron_ingot>, <cyclicmagic:ender_pearl_reuse>, <minecraft:iron_ingot>]]);
...
recipes.addShaped(<thermalfoundation:material:512>, [[<moreplates:red_alloy_plate>, <ore:plateIron>, <moreplates:red_alloy_plate>],[null, <ore:plateIron>, null], [<moreplates:red_alloy_plate>, <ore:plateIron>, <moreplates:red_alloy_plate>]]);
...
recipes.addShaped(<thermalexpansion:device>, [[null, <botania:openbucket>, null],[<extrautils2:decorativeglass>, <thermalexpansion:frame:64>, <extrautils2:decorativeglass>], [<thermalfoundation:material:26>, <cyclicmagic:fluid_drain>, <thermalfoundation:material:26>]]);
