...
recipes.addShaped(<industrialupgrade:simplemachine>, [[<moreplates:electrical_steel_plate>, <randomthings:blockbreaker>, <moreplates:electrical_steel_plate>],[<industrialupgrade:crafting_elements:69>, <enderio:block_sag_mill>, <industrialupgrade:crafting_elements:72>], [<moreplates:electrical_steel_plate>, <industrialupgrade:crafting_elements:272>, <moreplates:electrical_steel_plate>]]);
...
mods.avaritia.ExtremeCrafting.addShaped("Matter Fabricator", <industrialupgrade:simplemachine:6> * 1, [[null, null, null, null, null, null, null, null, null], [null, null, null, null, null, null, null, null, null],[null, null, null, <industrialupgrade:blockresource:9>, <industrialupgrade:rune_energy>, <industrialupgrade:blockresource:9>, null, null, null],[null, null, <industrialupgrade:blockresource:9>, <animus:component:5>, <industrialupgrade:crafting_elements:273>, <animus:component:5>, <industrialupgrade:blockresource:9>, null, null],[null, null, <industrialupgrade:rune_energy>, <industrialupgrade:crafting_elements:273>, <packagedastral:constellation_crafter>, <industrialupgrade:crafting_elements:273>, <industrialupgrade:rune_energy>, null, null],[null, null, <industrialupgrade:blockresource:9>, <animus:component:5>, <industrialupgrade:charging_lapotron_crystal>, <animus:component:5>, <industrialupgrade:blockresource:9>, null, null],[null, null, null, <industrialupgrade:blockresource:9>, <industrialupgrade:rune_energy>, <industrialupgrade:blockresource:9>, null, null, null],[null, null, null, null, null, null, null, null, null],[null, null, null, null, null, null, null, null, null]]);
...
mods.industrialupgrade.rolling.addRecipe(<moreplates:electrotine_alloy_plate>, <projectred-core:resource_item:104>);
mods.industrialupgrade.rolling.addRecipe(<moreplates:red_alloy_plate>, <projectred-core:resource_item:103>);
mods.industrialupgrade.rolling.addRecipe(<moreplates:fiery_plate>, <twilightforest:fiery_ingot>);
mods.industrialupgrade.rolling.addRecipe(<moreplates:ironwood_plate>, <twilightforest:ironwood_ingot>);
mods.industrialupgrade.rolling.addRecipe(<moreplates:knightmetal_plate>, <twilightforest:knightmetal_ingot>);
...
mods.industrialupgrade.gearing.addRecipe(<moreplates:electrotine_alloy_gear>, <projectred-core:resource_item:104> * 4);
mods.industrialupgrade.gearing.addRecipe(<moreplates:red_alloy_gear>, <projectred-core:resource_item:103> * 4);
mods.industrialupgrade.gearing.addRecipe(<moreplates:fiery_gear>, <twilightforest:fiery_ingot> * 4);
mods.industrialupgrade.gearing.addRecipe(<moreplates:ironwood_gear>, <twilightforest:ironwood_ingot> * 4);
mods.industrialupgrade.gearing.addRecipe(<moreplates:knightmetal_gear>, <twilightforest:knightmetal_ingot> * 4);
...
mods.industrialupgrade.GenMicrochip.addRecipe(<appliedenergistics2:material:54>, <minecraft:lapis_block>, <enderio:item_fluid_filter>, <forestry:can> * 12, <appliedenergistics2:part:140> * 4, <appliedenergistics2:quartz_glass> * 4, 1500);
mods.industrialupgrade.GenMicrochip.addRecipe(<appliedenergistics2:material:55>, <appliedenergistics2:material:54> * 3, <minecraft:lapis_block>, <enderio:item_fluid_filter> * 2, <cyclicmagic:block_storeempty> * 4, <industrialupgrade:crafting_elements:27>, 2000);
mods.industrialupgrade.GenMicrochip.addRecipe(<appliedenergistics2:material:56>, <appliedenergistics2:material:55> * 3, <minecraft:lapis_block>, <rftools:fluidplus_module> * 2, <cyclicmagic:block_storeempty> * 4, <industrialupgrade:crafting_elements:6>, 2500);
mods.industrialupgrade.GenMicrochip.addRecipe(<appliedenergistics2:material:57>, <appliedenergistics2:material:56> * 3, <industrialupgrade:itemdoubleplates:23> * 4, <rftools:fluidplus_module> * 2, <industrialupgrade:itemcell> * 4, <industrialupgrade:crafting_elements:83>, 3000);
mods.industrialupgrade.GenMicrochip.addRecipe(<appliedenergistics2:material:68>, <appliedenergistics2:material:57> * 3, <industrialupgrade:itemdoubleplates:23> * 4, <rftools:fluidplus_module> * 2, <industrialupgrade:itemcell> * 4, <contenttweaker:iridescent_certus_crystal_plate>, 4000);
mods.industrialupgrade.GenMicrochip.addRecipe(<appliedenergistics2:material:69>, <appliedenergistics2:material:68> * 3, <industrialupgrade:itemdoubleplates:23> * 4, <rftools:fluidplus_module> * 2, <forestry:refractory> * 4, <contenttweaker:iridescent_certus_crystal_plate>, 5000);
mods.industrialupgrade.GenMicrochip.addRecipe(<appliedenergistics2:material:70>, <appliedenergistics2:material:69> * 3, <industrialupgrade:itemdoubleplates:23> * 4, <rftools:fluidplus_module> * 2, <forestry:refractory> * 4, <contenttweaker:refractive_crystal_plate>, 5000);
...
mods.industrialupgrade.GenMicrochip.addRecipe(<appliedenergistics2:spatial_storage_cell_2_cubed>, <appliedenergistics2:material:39>, <enderio:item_capacitor_melodic> * 2, <rftools:space_chamber_controller>, <thermalfoundation:material:359> * 4, <appliedenergistics2:material:32>, 4000);
...
mods.industrialupgrade.GenMicrochip.addRecipe(<solarflux:photovoltaic_cell_4>, <industrialupgrade:circuit:9>, <moreplates:vibrant_alloy_plate> * 4, <industrialupgrade:itemplates:2> * 2, <thermalfoundation:glass_alloy:5> * 4, <solarflux:photovoltaic_cell_3>, 1000);
mods.industrialupgrade.GenMicrochip.addRecipe(<solarflux:photovoltaic_cell_5>, <industrialupgrade:circuit:10>, <moreplates:energetic_silver_plate> * 4, <contenttweaker:compressed_honeycomb_radioactive> * 2, <thermalfoundation:glass_alloy:6> * 4, <solarflux:photovoltaic_cell_4>, 2000);
mods.industrialupgrade.GenMicrochip.addRecipe(<solarflux:photovoltaic_cell_6>, <industrialupgrade:circuit:10>, <moreplates:melodic_alloy_plate> * 4, <contenttweaker:iridescent_radioactive_honeycomb_crystal> * 2, <thermalfoundation:glass_alloy:7> * 4, <solarflux:photovoltaic_cell_5>, 3000);
//mods.industrialupgrade.GenMicrochip.addRecipe(<solarflux:photovoltaic_cell_dark_matter>, <industrialupgrade:circuit:11>, <moreplates:stellar_alloy_plate> * 4, <blackholestorage:dark_matter> * 4, <thermalfoundation:glass:7> * 4, <solarflux:photovoltaic_cell_6>, 4000);
////mods.industrialupgrade.GenMicrochip.addRecipe(<appliedenergistics2:material:28>, <thaumictinkerer:soul_mould>, <avaritia:resource>, <forestry:thermionic_tubes:5>, <enderio:item_capacitor_crystalline>, <industrialupgrade:crafting_elements:25>, 3000);
////mods.industrialupgrade.GenMicrochip.addRecipe(<appliedenergistics2:material:25>, <thaumictinkerer:soul_mould>, <industrialupgrade:itemdoubleplates:21>, <forestry:thermionic_tubes:4>, <enderio:item_basic_capacitor:2>, <industrialupgrade:crafting_elements:21>, 2500);
mods.industrialupgrade.GenMicrochip.addRecipe(<appliedenergistics2:material:30>*3, <appliedenergistics2:material:28>, <industrialupgrade:upgrades>*2, <astralsorcery:itemcoloredlens:5>, <extrautils2:ingredients:15> *2, <botania:lens:4>, 3000); 
mods.industrialupgrade.GenMicrochip.addRecipe(<appliedenergistics2:material:53>, <appliedenergistics2:material:25>, <botania:manaresource:12>, <appliedenergistics2:part:280>, <storagedrawers:upgrade_status:1>, <avaritia:double_compressed_crafting_table>, 2500);
mods.industrialupgrade.GenMicrochip.addRecipe(<appliedenergistics2:material:27>, <appliedenergistics2:material:25>, <astralsorcery:itemcraftingcomponent:4>, <solarflux:blank_upgrade>, <storagedrawers:upgrade_storage:4>, <enderio:item_dark_steel_upgrade:1>.withTag({"enderio:dsu": "enderio:inv1"}), 2500);
...
mods.industrialupgrade.GenMicrochip.addRecipe(<appliedenergistics2:material:58>, <appliedenergistics2:material:28>, <appliedenergistics2:interface>, <ironchest:diamond_crystal_chest_upgrade>, <solarflux:blank_upgrade>, <enderio:item_dark_steel_upgrade:1>.withTag({"enderio:dsu": "enderio:inv2"}), 3000);
//mods.industrialupgrade.GenMicrochip.addRecipe(<aroma1997sdimension:portalframe>, <aroma1997sdimension:miningmultitool>, <divinerpg:teleportation_star>, <botanicadds:rune_tp>, <bloodmagic:component:3>, <appliedenergistics2:material:47> *4, 4000);

mods.industrialupgrade.GenMicrochip.addRecipe(<appliedenergistics2:part:260>,<industrialupgrade:upgrades:11>, <enderio:item_basic_item_filter>, <extrautils2:grocket>, <appliedenergistics2:material:43>, <astralsorcery:itemcoloredlens:5>, 2500);
mods.industrialupgrade.GenMicrochip.addRecipe(<appliedenergistics2:part:240>,<industrialupgrade:upgrades:12>, <thermaldynamics:filter:2>, <cyclicmagic:item_pump>, <appliedenergistics2:material:44>, <astralsorcery:itemcoloredlens:6>, 2500);
mods.industrialupgrade.GenMicrochip.addRecipe(<appliedenergistics2:part:261>, <bloodmagic:component>, <extrautils2:grocket:2>, <industrialupgrade:upgrades:13>, <appliedenergistics2:material:43>, <botania:pistonrelay>, 2500);
mods.industrialupgrade.GenMicrochip.addRecipe(<appliedenergistics2:part:241>, <botania:rune>, <cyclicmagic:fluid_pump>, <industrialupgrade:upgrades:14>, <appliedenergistics2:material:44>, <botania:pistonrelay>, 2500);

mods.industrialupgrade.GenMicrochip.addRecipe(<appliedenergistics2:crafting_accelerator>, <appliedenergistics2:crafting_unit>,<extrautils2:ingredients:15>*2, <appliedenergistics2:quartz_vibrant_glass> * 4, <appliedenergistics2:material:30> * 2, <enderio:item_extract_speed_upgrade> * 4, 1500);
mods.industrialupgrade.GenMicrochip.addRecipe(<appliedenergistics2:crafting_accelerator_4x>, <appliedenergistics2:crafting_accelerator>*2, <extrautils2:ingredients:16>*2, <industrialupgrade:blockresource:7>, <contenttweaker:ae2uel_processor_universal>*4, <industrialupgrade:crafting_elements:155>*2, 3000);
mods.industrialupgrade.GenMicrochip.addRecipe(<appliedenergistics2:crafting_accelerator_16x>, <appliedenergistics2:crafting_accelerator_4x>*3, <industrialupgrade:upgrades> * 2, <industrialupgrade:blockresource:7>*2, <threng:material:6>*16, <teslacorelib:speed_tier2>*2, 3000);
mods.industrialupgrade.GenMicrochip.addRecipe(<appliedenergistics2:crafting_accelerator_64x>, <appliedenergistics2:crafting_accelerator_16x>*3, <industrialupgrade:quarrymodules:1>*2, <industrialupgrade:blockresource:7>*4, <threng:material:14>*64, <appliedenergistics2:material:30>*2, 3500);
////mods.industrialupgrade.GenMicrochip.addRecipe(<appliedenergistics2:crafting_accelerator_128x>, <appliedenergistics2:crafting_accelerator_64x>*2, <industrialupgrade:quarrymodules:1>*2, <industrialupgrade:blockresource:7>*4, <threng:big_assembler:4>*2,<thaumcraft:matrix_speed>, 4000);
mods.industrialupgrade.GenMicrochip.addRecipe(<appliedenergistics2:crafting_accelerator_256x>, <appliedenergistics2:crafting_accelerator_128x>*2, <industrialupgrade:quarrymodules:2>, <industrialupgrade:blockresource:7>*8, <threng:big_assembler:4>*4,<bloodarsenal:base_item:8>*2, 4500);
mods.industrialupgrade.GenMicrochip.addRecipe(<appliedenergistics2:crafting_accelerator_512x>, <appliedenergistics2:crafting_accelerator_256x>*2, <industrialupgrade:quarrymodules:3>, <industrialupgrade:blockresource:7>*16, <threng:big_assembler:4>*8,<astralsorcery:itemtunedcelestialcrystal>.withTag({astralsorcery: {constellationName: "astralsorcery.constellation.horologium", crystalProperties: {collectiveCapability: 100, size: 900, fract: 0, purity: 100, sizeOverride: -1}}}), 5000);
mods.industrialupgrade.GenMicrochip.addRecipe(<appliedenergistics2:crafting_accelerator_1024x>, <appliedenergistics2:crafting_accelerator_512x>*2, <industrialupgrade:quarrymodules:4>, <industrialupgrade:blockresource:7>*32, <threng:big_assembler:4>*16,<astralsorcery:itemtunedcelestialcrystal>.withTag({astralsorcery: {constellationName: "astralsorcery.constellation.horologium", crystalProperties: {collectiveCapability: 100, size: 900, fract: 0, purity: 100, sizeOverride: -1}}}), 5000);

mods.industrialupgrade.GenMicrochip.addRecipe(<appliedenergistics2:improved_energy_cell>, <appliedenergistics2:dense_energy_cell>*2, <industrialupgrade:rune_energy>*2, <industrialupgrade:upgrades:4>, <industrialupgrade:modules:9>, <teslacorelib:energy_tier1>*2, 4000);
mods.industrialupgrade.GenMicrochip.addRecipe(<appliedenergistics2:advanced_energy_cell>, <appliedenergistics2:improved_energy_cell>*2, <industrialupgrade:rune_energy>*4, <industrialupgrade:upgrades:5>, <industrialupgrade:modules:10>, <teslacorelib:energy_tier2>*2, 4000);
mods.industrialupgrade.GenMicrochip.addRecipe(<appliedenergistics2:perfect_energy_cell>, <appliedenergistics2:advanced_energy_cell>*2, <industrialupgrade:rune_energy>*8, <industrialupgrade:upgrades:6>, <industrialupgrade:modules:11>, <teslacorelib:energy_tier2>*2, 4500);    
mods.industrialupgrade.GenMicrochip.addRecipe(<appliedenergistics2:dense_energy_cell>, <appliedenergistics2:energy_cell>*8, <industrialupgrade:rune_energy>, <rftools:energyplus_module>, <enderio:item_basic_capacitor:2>*2, <teslacorelib:energy_tier1>, 2000);
...
mods.industrialupgrade.DoubleMolecularTransformer.addRecipe(<contenttweaker:iridium_fiery>, <industrialupgrade:crafting_elements:275>, <twilightforest:block_storage:1>, 1000000);
...
mods.industrialupgrade.MolecularTransformer.addRecipe(<mysticalagriculture:electrotine_essence> *2, <mysticalagriculture:electrotine_seeds> , 105000);
mods.industrialupgrade.MolecularTransformer.addRecipe(<mysticalagriculture:steeleaf_essence> *2, <mysticalagriculture:steeleaf_seeds> , 105000);
mods.industrialupgrade.MolecularTransformer.addRecipe(<mysticalagriculture:ironwood_essence> *2, <mysticalagriculture:ironwood_seeds> , 105000);
mods.industrialupgrade.MolecularTransformer.addRecipe(<mysticalagriculture:knightmetal_essence> *2, <mysticalagriculture:knightmetal_seeds> , 105000);
mods.industrialupgrade.MolecularTransformer.addRecipe(<mysticalagriculture:fiery_ingot_essence> *2, <mysticalagriculture:fiery_ingot_seeds> , 105000);
...
mods.industrialupgrade.MolecularTransformer.addRecipe(<mysticalagriculture:electrotine_seeds> * 2, <mysticalagriculture:electrotine_essence>, 105000);
mods.industrialupgrade.MolecularTransformer.addRecipe(<mysticalagriculture:steeleaf_seeds> * 2, <mysticalagriculture:steeleaf_essence>, 105000);
mods.industrialupgrade.MolecularTransformer.addRecipe(<mysticalagriculture:ironwood_seeds> * 2, <mysticalagriculture:ironwood_essence>, 105000);
mods.industrialupgrade.MolecularTransformer.addRecipe(<mysticalagriculture:knightmetal_seeds> * 2, <mysticalagriculture:knightmetal_essence>, 105000);
mods.industrialupgrade.MolecularTransformer.addRecipe(<mysticalagriculture:fiery_ingot_seeds> * 2, <mysticalagriculture:fiery_ingot_essence>, 105000);
