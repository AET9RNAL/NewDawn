...
//Don't touch me!
//#Add
recipes.addShaped(<teslacorelib:base_addon>, [[<keletupack:warp_paper>, <moreplates:redstone_alloy_plate>, <keletupack:warp_paper>],[<astralsorcery:itemcraftingcomponent:5>, <tconstruct:fancy_frame:2>, <astralsorcery:itemcraftingcomponent:5>], [<keletupack:warp_paper>, <moreplates:redstone_alloy_plate>, <keletupack:warp_paper>]]);
