...
recipes.addShaped(<thermalinnovation:drill>, [[null, <thermalfoundation:material:656>, null],[<tconstruct:large_plate>.withTag({Material: "silver"}), <thermalfoundation:material:640>, <tconstruct:large_plate>.withTag({Material: "silver"})], [<minecraft:piston>, <thermalfoundation:material:24>, <minecraft:piston>]]);
recipes.addShaped(<thermalinnovation:magnet:4>, [[<endreborn:ingot_infused>, <randomthings:enderletter>, <endreborn:ingot_infused>],[<simplyjetpacks:metaitemmods:19>, <thermalinnovation:magnet:3>, <simplyjetpacks:metaitemmods:19>], [null, <simplyjetpacks:metaitemmods:19>, null]]);
