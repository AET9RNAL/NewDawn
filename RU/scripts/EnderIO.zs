...
recipes.addShaped(<enderio:block_simple_crafter>, [[<ore:gemSilicon>, <ore:gemSilicon>, <ore:gemSilicon>],[<ore:ingotIron>, <enderio:item_material>, <ore:ingotIron>], [<ore:gearStone>, <minecraft:barrier>, <ore:gearStone>]]);
...
recipes.addShaped(<enderio:block_simple_stirling_generator>, [[<minecraft:barrier>, <extrautils2:machine>, <minecraft:barrier>],[<taiga:prometheum_ingot>, <enderio:item_material>, <taiga:prometheum_ingot>], [<enderio:item_material:11>, <minecraft:piston>, <enderio:item_material:11>]]);
...
recipes.addShaped(<enderio:block_simple_alloy_smelter>, [[<minecraft:iron_ingot>, <industrialforegoing:resourceful_furnace>, <minecraft:iron_ingot>],[<thermalexpansion:machine>, <enderio:item_material>, <thermalexpansion:machine>], [<ore:gearStone>, <minecraft:barrier>, <ore:gearStone>]]);
...
mods.avaritia.ExtremeCrafting.addShaped("Enchanter", <enderio:block_enchanter> * 1, [[<enderio:block_alloy:8>, <enderio:block_alloy:6>, <enderio:block_alloy:6>, <enderio:block_alloy:6>, <enderio:block_alloy:6>, <enderio:block_alloy:6>, <enderio:block_alloy:6>, <enderio:block_alloy:6>, <enderio:block_alloy:8>], [<enderio:block_alloy:8>, <enderio:block_alloy:6>, <minecraft:barrier>, <botania:pylon:0>, <enderio:block_alloy:6>, <botania:pylon:0>, <minecraft:barrier>, <enderio:block_alloy:6>, <enderio:block_alloy:8>],[<enderio:block_alloy:8>, <enderio:block_alloy:8>, <enderio:block_alloy:8>, <enderio:block_alloy:8>, <minecraft:bookshelf>, <enderio:block_alloy:8>, <enderio:block_alloy:8>, <enderio:block_alloy:8>, <enderio:block_alloy:8>],[null, null, null, <enderio:block_alloy:8>, <minecraft:bookshelf>, <enderio:block_alloy:8>, null, null, null],[null, null, null, <enderio:block_alloy:8>, <minecraft:bookshelf>, <enderio:block_alloy:8>, null, null, null],[null, null, <enderio:block_alloy:8>, <enderio:block_alloy:8>, <minecraft:bookshelf>, <enderio:block_alloy:8>, <enderio:block_alloy:8>, null, null],[null, <enderio:block_alloy:8>, <moreplates:enchanted_gear>, <extrautils2:machine>.withTag({Type: "extrautils2:enchanter"}), <minecraft:barrier>, <industrialforegoing:enchantment_aplicator>, <moreplates:enchanted_gear>, <enderio:block_alloy:8>, null],[<enderio:block_alloy:8>, <extrautils2:simpledecorative:0>, <extrautils2:simpledecorative:0>, <extrautils2:simpledecorative:0>, <extrautils2:simpledecorative:0>, <extrautils2:simpledecorative:0>, <extrautils2:simpledecorative:0>, <extrautils2:simpledecorative:0>, <enderio:block_alloy:8>],[<enderio:block_alloy:8>, <enderio:block_alloy:8>, <enderio:block_alloy:8>, <enderio:block_alloy:8>, <enderio:block_alloy:8>, <enderio:block_alloy:8>, <enderio:block_alloy:8>, <enderio:block_alloy:8>, <enderio:block_alloy:8>]]);
