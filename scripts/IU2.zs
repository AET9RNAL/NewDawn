...
//#Remove
//recipes.remove(XXX);
recipes.remove(<industrialupgrade:advanced_re_battery>);
...
recipes.remove(<contenttweaker:perfect_industrial_casing:0>);
mods.avaritia.ExtremeCrafting.addShaped("Perfect_Industrial_Casing", <contenttweaker:perfect_industrial_casing:0> * 1, [[null, null, null, null, null, null, null, null, null], [null, null, <industrialupgrade:alloydoubleplate:8>, <industrialupgrade:alloydoubleplate:8>, <industrialupgrade:alloydoubleplate:8>, <industrialupgrade:alloydoubleplate:8>, <industrialupgrade:alloydoubleplate:8>, null, null],[null, <industrialupgrade:alloydoubleplate:8>, <industrialupgrade:blockresource:9>, <industrialupgrade:blockresource:9>, <industrialupgrade:blockresource:9>, <industrialupgrade:blockresource:9>, <industrialupgrade:blockresource:9>, <industrialupgrade:alloydoubleplate:8>, null],[null, <industrialupgrade:alloydoubleplate:8>, <industrialupgrade:blockresource:9>, <simplyjetpacks:metaitemmods:30>, <industrialupgrade:crafting_elements:139>, <simplyjetpacks:metaitemmods:30>, <industrialupgrade:blockresource:9>, <industrialupgrade:alloydoubleplate:8>, null],[null, <industrialupgrade:alloydoubleplate:8>, <industrialupgrade:blockresource:9>, <industrialupgrade:crafting_elements:139>, <industrialupgrade:crafting_elements:139>, <industrialupgrade:crafting_elements:139>, <industrialupgrade:blockresource:9>, <industrialupgrade:alloydoubleplate:8>, null],[null, <industrialupgrade:alloydoubleplate:8>, <industrialupgrade:blockresource:9>, <simplyjetpacks:metaitemmods:30>, <industrialupgrade:crafting_elements:139>, <simplyjetpacks:metaitemmods:30>, <industrialupgrade:blockresource:9>, <industrialupgrade:alloydoubleplate:8>, null],[null, <industrialupgrade:alloydoubleplate:8>, <industrialupgrade:blockresource:9>, <industrialupgrade:blockresource:9>, <industrialupgrade:blockresource:9>, <industrialupgrade:blockresource:9>, <industrialupgrade:blockresource:9>, <industrialupgrade:alloydoubleplate:8>, null],[null, null, <industrialupgrade:alloydoubleplate:8>, <industrialupgrade:alloydoubleplate:8>, <industrialupgrade:alloydoubleplate:8>, <industrialupgrade:alloydoubleplate:8>, <industrialupgrade:alloydoubleplate:8>, null, null],[null, null, null, null, null, null, null, null, null]]);
