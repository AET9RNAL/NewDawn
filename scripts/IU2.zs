...
val itemsToRemove = [
	...
	<industrialupgrade:nano_saber:27>,
    ...
    <industrialupgrade:nano_saber:27>,
    <industrialupgrade:nanodrill>,
    <industrialupgrade:spectral_helmet>,
    <industrialupgrade:spectral_chestplate>,
    <industrialupgrade:spectral_leggings>,
    <industrialupgrade:spectral_boots>,
    <industrialupgrade:quantumdrill>,
    <industrialupgrade:quantum_boots>,
    <industrialupgrade:quantum_chestplate>,
    <industrialupgrade:quantum_helmet>,
    <industrialupgrade:quantum_leggings>,
    <industrialupgrade:itemnanosaber1:27>,
	...
	<industrialupgrade:spectral_bow>,
	<industrialupgrade:itemnanosaber:27>,
