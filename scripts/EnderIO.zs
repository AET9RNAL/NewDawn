...
mods.extendedcrafting.TableCrafting.addShaped(0, <avaritiaio:infinitecapacitor>, [
    ...
    [<contenttweaker:chaotic_capacitor>, <draconicevolution:tool_upgrade:0>, <industrialupgrade:quarrymodules:5>, <iuadditions:plate:1>, <iuadditions:plate:1>, <iuadditions:plate:1>, <industrialupgrade:quarrymodules:5>, <draconicevolution:tool_upgrade:0>, <contenttweaker:chaotic_capacitor>],
    ...
    [<draconicevolution:awakened_core>, <iuadditions:plate:4>, <enderio:item_capacitor_stellar>, <ore:circuitNeutronium>, <enderio:item_capacitor_stellar>, <ore:circuitNeutronium>, <enderio:item_capacitor_stellar>, <iuadditions:plate:4>, <draconicevolution:awakened_core>],
    [<extrautils2:ingredients:16>, <iuadditions:plate:4>, <industrialupgrade:upgrades:1>, <enderio:item_capacitor_stellar>, <draconicevolution:draconium_capacitor:0>, <enderio:item_capacitor_stellar>, <industrialupgrade:upgrades:1>, <iuadditions:plate:4>, <extrautils2:ingredients:16>],
    [<draconicevolution:awakened_core>, <iuadditions:plate:4>, <enderio:item_capacitor_stellar>, <ore:circuitNeutronium>, <enderio:item_capacitor_stellar>, <ore:circuitNeutronium>, <enderio:item_capacitor_stellar>, <iuadditions:plate:4>, <draconicevolution:awakened_core>],
    [<contenttweaker:chaotic_capacitor>, <industrialupgrade:quarrymodules:5>, <enderio:item_capacitor_stellar>, <enderio:item_capacitor_stellar>, <industrialupgrade:upgrades:1>, <enderio:item_capacitor_stellar>, <enderio:item_capacitor_stellar>, <industrialupgrade:quarrymodules:5>, <contenttweaker:chaotic_capacitor>],
    [<contenttweaker:chaotic_capacitor>, <draconicevolution:tool_upgrade:0>, <industrialupgrade:quarrymodules:5>, <iuadditions:plate:1>, <iuadditions:plate:1>, <iuadditions:plate:1>, <industrialupgrade:quarrymodules:5>, <draconicevolution:tool_upgrade:0>, <contenttweaker:chaotic_capacitor>],
    [<industrialupgrade:modules:11>, <contenttweaker:chaotic_capacitor>, <contenttweaker:chaotic_capacitor>, <draconicevolution:awakened_core>, <extrautils2:ingredients:16>, <draconicevolution:awakened_core>, <contenttweaker:chaotic_capacitor>, <contenttweaker:chaotic_capacitor>, <industrialupgrade:modules:11>]
...
mods.extendedcrafting.TableCrafting.addShaped(0, <enderio:block_cap_bank:0>, [
    [<iuadditions:plate:2>, <iuadditions:plate:2>, <moreplates:stellar_alloy_plate>, <moreplates:stellar_alloy_plate>, <moreplates:stellar_alloy_plate>, <moreplates:stellar_alloy_plate>, <moreplates:stellar_alloy_plate>, <iuadditions:plate:2>, <iuadditions:plate:2>],
    [<iuadditions:plate:2>, <iuadditions:divinerpg_elements:30>, <iuadditions:divinerpg_elements:30>, <iuadditions:divinerpg_elements:30>, <iuadditions:divinerpg_elements:30>, <iuadditions:divinerpg_elements:30>, <industrialupgrade:itemcore:6>, <draconicevolution:wyvern_core>, <iuadditions:plate:2>],
