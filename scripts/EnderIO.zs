...
recipes.addShaped(<enderio:item_endergy_conduit:2> * 2, [[<simplyjetpacks:metaitemmods:3>, <simplyjetpacks:metaitemmods:3>, <simplyjetpacks:metaitemmods:3>],[<ore:plateAluminium>, <enderio:item_endergy_conduit:1>, <ore:plateAluminium>], [<simplyjetpacks:metaitemmods:3>, <simplyjetpacks:metaitemmods:3>, <simplyjetpacks:metaitemmods:3>]]);
...
recipes.addShaped(<enderio:item_endergy_conduit:11> * 2, [[<iuadditions:astral_element:3>, <iuadditions:astral_element:3>, <iuadditions:astral_element:3>],[<enderio:item_endergy_conduit:10>, <enderio:item_endergy_conduit:10>, <enderio:item_endergy_conduit:10>], [<iuadditions:astral_element:3>, <iuadditions:astral_element:3>, <iuadditions:astral_element:3>]]);
...
mods.extendedcrafting.TableCrafting.addShaped(0, <enderio:block_creative_spawner>, [
    ...
    [<draconicevolution:reactor_component:0>, <draconicevolution:reactor_component:0>, <draconicevolution:reactor_component:0>, <iuadditions:divinerpg_elements:35>, <draconicadditions:chaos_crystal_stable>, <iuadditions:divinerpg_elements:35>, <draconicevolution:reactor_component:0>, <draconicevolution:reactor_component:0>, <draconicevolution:reactor_component:0>],
...
mods.extendedcrafting.TableCrafting.addShaped(0, <avaritiaio:infinitecapacitor>, [
    ...
    [<contenttweaker:chaotic_capacitor>, <draconicevolution:tool_upgrade:0>, <industrialupgrade:quarrymodules:5>, <iuadditions:honey_plate:1>, <iuadditions:honey_plate:1>, <iuadditions:honey_plate:1>, <industrialupgrade:quarrymodules:5>, <draconicevolution:tool_upgrade:0>, <contenttweaker:chaotic_capacitor>],
    ...
    [<draconicevolution:awakened_core>, <iuadditions:honey_plate:4>, <enderio:item_capacitor_stellar>, <ore:circuitNeutronium>, <enderio:item_capacitor_stellar>, <ore:circuitNeutronium>, <enderio:item_capacitor_stellar>, <iuadditions:honey_plate:4>, <draconicevolution:awakened_core>],
    [<extrautils2:ingredients:16>, <iuadditions:honey_plate:4>, <industrialupgrade:upgrades:1>, <enderio:item_capacitor_stellar>, <draconicevolution:draconium_capacitor:0>, <enderio:item_capacitor_stellar>, <industrialupgrade:upgrades:1>, <iuadditions:honey_plate:4>, <extrautils2:ingredients:16>],
    [<draconicevolution:awakened_core>, <iuadditions:honey_plate:4>, <enderio:item_capacitor_stellar>, <ore:circuitNeutronium>, <enderio:item_capacitor_stellar>, <ore:circuitNeutronium>, <enderio:item_capacitor_stellar>, <iuadditions:honey_plate:4>, <draconicevolution:awakened_core>],
    [<contenttweaker:chaotic_capacitor>, <industrialupgrade:quarrymodules:5>, <enderio:item_capacitor_stellar>, <enderio:item_capacitor_stellar>, <industrialupgrade:upgrades:1>, <enderio:item_capacitor_stellar>, <enderio:item_capacitor_stellar>, <industrialupgrade:quarrymodules:5>, <contenttweaker:chaotic_capacitor>],
    [<contenttweaker:chaotic_capacitor>, <draconicevolution:tool_upgrade:0>, <industrialupgrade:quarrymodules:5>, <iuadditions:honey_plate:1>, <iuadditions:honey_plate:1>, <iuadditions:honey_plate:1>, <industrialupgrade:quarrymodules:5>, <draconicevolution:tool_upgrade:0>, <contenttweaker:chaotic_capacitor>],
    [<industrialupgrade:modules:11>, <contenttweaker:chaotic_capacitor>, <contenttweaker:chaotic_capacitor>, <draconicevolution:awakened_core>, <extrautils2:ingredients:16>, <draconicevolution:awakened_core>, <contenttweaker:chaotic_capacitor>, <contenttweaker:chaotic_capacitor>, <industrialupgrade:modules:11>]
...
mods.extendedcrafting.TableCrafting.addShaped(0, <enderio:block_cap_bank:0>, [
    [<iuadditions:honey_plate:2>, <iuadditions:honey_plate:2>, <moreplates:stellar_alloy_plate>, <moreplates:stellar_alloy_plate>, <moreplates:stellar_alloy_plate>, <moreplates:stellar_alloy_plate>, <moreplates:stellar_alloy_plate>, <iuadditions:honey_plate:2>, <iuadditions:honey_plate:2>],
    [<iuadditions:honey_plate:2>, <iuadditions:divinerpg_elements:30>, <iuadditions:divinerpg_elements:30>, <iuadditions:divinerpg_elements:30>, <iuadditions:divinerpg_elements:30>, <iuadditions:divinerpg_elements:30>, <industrialupgrade:itemcore:6>, <draconicevolution:wyvern_core>, <iuadditions:honey_plate:2>],
    [<moreplates:stellar_alloy_plate>, <draconicevolution:wyvern_core>, <enderio:item_capacitor_totemic>, <enderio:item_extract_speed_upgrade:0>, <enderio:item_endergy_conduit:10>, <enderio:item_extract_speed_upgrade:0>, <enderio:item_capacitor_totemic>, <iuadditions:divinerpg_elements:30>, <moreplates:stellar_alloy_plate>],
    [<moreplates:stellar_alloy_plate>, <industrialupgrade:itemcore:7>, <enderio:item_extract_speed_upgrade:0>, <industrialupgrade:upgrades:6>, <industrialupgrade:transformer_iu:0>, <industrialupgrade:upgrades:6>, <enderio:item_extract_speed_upgrade:0>, <iuadditions:divinerpg_elements:30>, <moreplates:stellar_alloy_plate>],
    [<moreplates:stellar_alloy_plate>, <industrialupgrade:upgradekitmachine:3>, <enderio:item_endergy_conduit:10>, <industrialupgrade:transformer_iu:0>, <enderio:block_solar_panel:6>, <industrialupgrade:transformer_iu:0>, <enderio:item_endergy_conduit:10>, <iuadditions:divinerpg_elements:30>, <moreplates:stellar_alloy_plate>],
    [<moreplates:stellar_alloy_plate>, <industrialupgrade:itemcore:7>, <enderio:item_extract_speed_upgrade:0>, <industrialupgrade:upgrades:6>, <industrialupgrade:transformer_iu:0>, <industrialupgrade:upgrades:6>, <enderio:item_extract_speed_upgrade:0>, <iuadditions:divinerpg_elements:30>, <moreplates:stellar_alloy_plate>],
    [<moreplates:stellar_alloy_plate>, <draconicevolution:wyvern_core>, <enderio:item_capacitor_totemic>, <enderio:item_extract_speed_upgrade:0>, <enderio:item_endergy_conduit:10>, <enderio:item_extract_speed_upgrade:0>, <enderio:item_capacitor_totemic>, <iuadditions:divinerpg_elements:30>, <moreplates:stellar_alloy_plate>],
    [<iuadditions:honey_plate:2>, <iuadditions:divinerpg_elements:30>, <iuadditions:divinerpg_elements:30>, <iuadditions:divinerpg_elements:30>, <iuadditions:divinerpg_elements:30>, <iuadditions:divinerpg_elements:30>, <industrialupgrade:itemcore:6>, <draconicevolution:wyvern_core>, <iuadditions:honey_plate:2>],
    [<iuadditions:honey_plate:2>, <iuadditions:honey_plate:2>, <moreplates:stellar_alloy_plate>, <moreplates:stellar_alloy_plate>, <moreplates:stellar_alloy_plate>, <moreplates:stellar_alloy_plate>, <moreplates:stellar_alloy_plate>, <iuadditions:honey_plate:2>, <iuadditions:honey_plate:2>]
