...
//Don't touch me!
//#Add
recipes.addShaped(<teslacorelib:base_addon>, [[<industrialupgrade:itemplates:27>, <moreplates:redstone_alloy_plate>, <industrialupgrade:itemplates:27>],[<astralsorcery:itemcraftingcomponent:5>, null, <astralsorcery:itemcraftingcomponent:5>], [<industrialupgrade:itemplates:27>, <moreplates:redstone_alloy_plate>, <industrialupgrade:itemplates:27>]]);
