...
mods.extendedcrafting.TableCrafting.addShaped(0, <thermalexpansion:cell>.withTag({Recv:25000,RSControl:0 as byte,Facing:2 as byte,Creative:1 as byte,Energy:50000000,Level:4 as byte,SideCache:[2,2,2,2,2,2] as byte[] as byte[],Send:25000}), [
    ...
    [<simplyjetpacks:metaitemmods:30>, <thermalexpansion:augment:656>, <iuadditions:honey_plate:4>, <thermalfoundation:storage_alloy:7>, <iuadditions:honey_plate:4>, <thermalfoundation:storage_alloy:7>, <iuadditions:honey_plate:4>, <thermalexpansion:augment:656>, <simplyjetpacks:metaitemmods:30>],
    [<simplyjetpacks:metaitemmods:19>, <iuadditions:honey_plate:4>, <industrialupgrade:itemcore:5>, <draconicevolution:draconic_core>, <thermalexpansion:augment:512>, <draconicevolution:draconic_core>, <industrialupgrade:itemcore:5>, <iuadditions:honey_plate:4>, <simplyjetpacks:metaitemmods:19>],
    ...
    [<redstonearsenal:material:224>, <iuadditions:honey_plate:4>, <thermalexpansion:augment:512>, <thermalfoundation:upgrade:35>, <enderio:block_solar_panel:5>, <thermalfoundation:upgrade:35>, <thermalexpansion:augment:512>, <iuadditions:honey_plate:4>, <redstonearsenal:material:224>],
    [<simplyjetpacks:metaitemmods:19>, <thermalfoundation:storage_alloy:7>, <draconicevolution:draconic_core>, <thermalexpansion:augment:513>, <thermalfoundation:upgrade:35>, <thermalexpansion:augment:513>, <draconicevolution:draconic_core>, <thermalfoundation:storage_alloy:7>, <simplyjetpacks:metaitemmods:19>],
    [<simplyjetpacks:metaitemmods:19>, <iuadditions:honey_plate:4>, <industrialupgrade:itemcore:5>, <draconicevolution:draconic_core>, <thermalexpansion:augment:512>, <draconicevolution:draconic_core>, <industrialupgrade:itemcore:5>, <iuadditions:honey_plate:4>, <simplyjetpacks:metaitemmods:19>],
    [<simplyjetpacks:metaitemmods:30>, <thermalexpansion:augment:656>, <iuadditions:honey_plate:4>, <thermalfoundation:storage_alloy:7>, <iuadditions:honey_plate:4>, <thermalfoundation:storage_alloy:7>, <iuadditions:honey_plate:4>, <thermalexpansion:augment:656>, <simplyjetpacks:metaitemmods:30>],
    [<simplyjetpacks:metaitemmods:30>, <simplyjetpacks:metaitemmods:30>, <simplyjetpacks:metaitemmods:19>, <simplyjetpacks:metaitemmods:19>, <redstonearsenal:material:224>, <simplyjetpacks:metaitemmods:19>, <simplyjetpacks:metaitemmods:19>, <simplyjetpacks:metaitemmods:30>, <simplyjetpacks:metaitemmods:30>]
