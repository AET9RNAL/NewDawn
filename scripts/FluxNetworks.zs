...
recipes.addShaped(<fluxnetworks:fluxcore> * 4, [[<minecraft:obsidian>, <fluxnetworks:flux>, <minecraft:obsidian>],[<fluxnetworks:flux>, <simplyjetpacks:metaitemmods:30>, <fluxnetworks:flux>], [<minecraft:obsidian>, <fluxnetworks:flux>, <minecraft:obsidian>]]);
