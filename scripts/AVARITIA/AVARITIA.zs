...
mods.extendedcrafting.TableCrafting.addShaped(0, <avaritia:resource:5>, [
    ...
    [<mekanism:hdpe_sheet>, <botaniverse:morerune:3>, <thermalexpansion:florb>.withTag({Fluid: "astralsorcery.liquidstarlight"}), <avaritia:resource:7>, <draconicevolution:awakened_core>, <avaritia:resource:7>, <thermalexpansion:florb>.withTag({Fluid: "astralsorcery.liquidstarlight"}), <botaniverse:morerune:3>, <mekanism:hdpe_sheet>],
    [<contenttweaker:plate_alloy_industrial>, <industrialupgrade:lens:1>, <avaritia:ultimate_stew>, <industrialupgrade:crafting_elements:649>, <industrialupgrade:crafting_elements:648>, <industrialupgrade:crafting_elements:638>, <avaritia:ultimate_stew>, <industrialupgrade:lens:0>, <contenttweaker:plate_alloy_ender>],
    [<contenttweaker:matter_gaia_guardian>, <industrialupgrade:modulestype:2>, <draconicevolution:awakened_core>, <industrialupgrade:crafting_elements:639>, <eternalsingularity:eternal_singularity>, <industrialupgrade:crafting_elements:637>, <draconicevolution:awakened_core>, <industrialupgrade:modulestype:2>, <contenttweaker:matter_stellar>],
    [<contenttweaker:plate_alloy_botanical>, <industrialupgrade:lens:6>, <avaritia:ultimate_stew>, <industrialupgrade:crafting_elements:643>, <industrialupgrade:crafting_elements:640>, <industrialupgrade:crafting_elements:644>, <avaritia:ultimate_stew>, <industrialupgrade:lens:2>, <contenttweaker:plate_alloy_thermal>],
    [<mekanism:hdpe_sheet>, <botaniverse:morerune:3>, <thermalexpansion:florb>.withTag({Fluid: "astralsorcery.liquidstarlight"}), <avaritia:resource:7>, <draconicevolution:awakened_core>, <avaritia:resource:7>, <thermalexpansion:florb>.withTag({Fluid: "astralsorcery.liquidstarlight"}), <botaniverse:morerune:3>, <mekanism:hdpe_sheet>],
