...
mods.extendedcrafting.TableCrafting.addShaped(0, <astralsorcery:astralmachine_starlight_fabricator>, [
    ...
    [null, null, <iuadditions:astral_element:3>, <iuadditions:astral_element:3>, <iuadditions:astral_element:3>, null, null],
    [null, <iuadditions:astral_element:3>, <astralsorcery:iteminfusedglass>, <astralsorcery:iteminfusedglass>, <astralsorcery:iteminfusedglass>, <iuadditions:astral_element:3>, null],
    [null, <iuadditions:astral_element:3>, <astralsorcery:blockworldilluminator>, <astralsorcery:blockwell>, <astralsorcery:blockworldilluminator>, <iuadditions:astral_element:3>, null],
    [null, <iuadditions:astral_element:3>, <astralsorcery:blockworldilluminator>, <contenttweaker:server_core>, <astralsorcery:blockworldilluminator>, <iuadditions:astral_element:3>, null],
    [null, <iuadditions:astral_element:3>, <astralsorcery:blockblackmarble:1>, <iuadditions:astral_element:9>, <astralsorcery:blockblackmarble:1>, <iuadditions:astral_element:3>, null],
    [null, null, <iuadditions:astral_element:3>, <iuadditions:astral_element:3>, <iuadditions:astral_element:3>, null, null]
]);
...
//             <iuadditions:astral_element:9>, <industrialupgrade:excitednucleus:4>, <iuadditions:astral_element:9>,
...
//             <iuadditions:astral_element:8>, <iuadditions:astral_element:8>,
...
//     <astralsorcery:iteminfusedglass>, <astralsorcery:blocktreebeacon>, <astralsorcery:iteminfusedglass>,<iuadditions:astral_element:8>, <industrialupgrade:excitednucleus:6>, 
//     <iuadditions:astral_element:8>, <industrialupgrade:machines:33>, <astralsorcery:blockcelestialgateway>, <industrialupgrade:machines:33>,<iuadditions:astral_element:3>, 
//     <iuadditions:astral_element:3>, <iuadditions:astral_element:3>, <iuadditions:astral_element:3>,<iuadditions:astral_element:3>, <iuadditions:astral_element:3>,
//     <iuadditions:astral_element:3>, <iuadditions:astral_element:3>, <iuadditions:astral_element:3>, <iuadditions:astral_element:3>,<iuadditions:astral_element:3>, 
//     <iuadditions:astral_element:3>,<iuadditions:astral_element:8>, <iuadditions:astral_element:9>,<iuadditions:astral_element:9>, <iuadditions:astral_element:9>,
//     //Outer Items, indices 25+
...
//     <astralsorcery:iteminfusedglass>, <astralsorcery:blocktreebeacon>, <astralsorcery:iteminfusedglass>,<iuadditions:astral_element:8>, <industrialupgrade:excitednucleus:7>, 
//     <iuadditions:astral_element:8>, <industrialupgrade:machines:34>, <astralsorcery:blockcelestialgateway>, <industrialupgrade:machines:34>,<iuadditions:iridium_advanced_stellar>, 
//     <iuadditions:iridium_advanced_stellar>, <iuadditions:iridium_advanced_stellar>, <iuadditions:iridium_advanced_stellar>,<iuadditions:astral_element:3>, <iuadditions:astral_element:3>,
//     <iuadditions:astral_element:3>, <iuadditions:astral_element:3>, <iuadditions:astral_element:3>, <iuadditions:astral_element:3>,<iuadditions:astral_element:3>, 
//     <iuadditions:astral_element:3>,<iuadditions:astral_element:8>, <iuadditions:astral_element:9>,<iuadditions:astral_element:9>, <iuadditions:astral_element:9>,
//     //Outer Items, indices 25+
//     <astralsorcery:blockworldilluminator>, <astralsorcery:itemusabledust:1>, <astralsorcery:itemusabledust:1>, <extrautils2:suncrystal>, <extrautils2:suncrystal>, <astralsorcery:itemusabledust>, <astralsorcery:itemusabledust:1>, <astralsorcery:itemusabledust:1>, <astralsorcery:blockworldilluminator>, <astralsorcery:blockworldilluminator>
...
mods.astralsorcery.Altar.addTraitAltarRecipe("ND:shaped/internal/altar/quarry", <astralsorcery:astralmachine_astral_quarry>, 4500, 100, [
    <astralsorcery:blockmarble:6>, <forge:bucketfilled>.withTag({FluidName: "astralsorcery.liquidstarlight", Amount: 1000}), <astralsorcery:blockmarble:6>,<iuadditions:astral_element:8>, <astralsorcery:blockborehead:1>, 
    <iuadditions:astral_element:8>, <astralsorcery:blockmarble:6>, <iuadditions:astral_element:9>, <astralsorcery:blockmarble:6>,<astraladditions:block_starmetal>, 
...
//Luckx1
 mods.astralsorcery.Altar.addConstellationAltarRecipe("ND:shaped/internal/altar/Luckx1", <contenttweaker:module_luck_x1>, 2000, 10, [
             ...
             <astralsorcery:itemusabledust>, <iuadditions:astral_element:9>, <astralsorcery:itemusabledust>,
...
mods.astralsorcery.Altar.addTraitAltarRecipe("ND:shaped/internal/altar/crystallizer", <multiblocked:astralmachine_crystallizer>, 4500, 100, [
    <astralsorcery:itemcoloredlens:2>, <draconicevolution:wyvern_energy_core>, <astralsorcery:itemcoloredlens:2>,<ae2stuff:grower>, <iuadditions:astral_element:9>, 
...
mods.astralsorcery.Altar.addTraitAltarRecipe("ND:shaped/internal/altar/celestialcrystallizer", <multiblocked:astralmachine_celestial_crystallizer>, 4500, 100, [
    ...
    <mekanismecoenergistics:controlcircuitavaritia>, <industrialupgrade:rune_night>, <iuadditions:astral_element:8>, <industrialupgrade:rune_night>,<astralsorcery:blockblackmarble:6>, 
