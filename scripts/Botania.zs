...
RuneAltar.addRecipe(<contenttweaker:infinity_circuit>, [<contenttweaker:draconium_circuit>, <contenttweaker:awakened_draconium_circuit>, <contenttweaker:chaotic_circuit>, <contenttweaker:neutronium_circuit>, <iuadditions:astral_element:8>, <iuadditions:circuit_eden>, <iuadditions:circuit_wildwood>, <iuadditions:circuit_apalachia>, <iuadditions:circuit_skythern>, <iuadditions:circuit_mortum>, <iuadditions:circuit_arcana>, <industrialupgrade:circuit:11>, <genetics:misc:8>, <contenttweaker:ae2uel_processor_universal>, <avaritia:resource:4>, <threng:material:6>], 1000000);
